...
from menu import *
from regras import *
from verifica_apostas import *
from dificulta_bonus import *
from exibir_sorteios import *
...
while iniciar != "1" and iniciar != "2" and iniciar != "3" and iniciar != "4":
    iniciar = input("Escolha uma opção válida: ")
...
if iniciar == "1":
    ...
    while iniciar == "1" and moedas >0:
        print("")
        tipoaposta = str.lower(input("Digite [T] para trinca ou [P] para par: "))
        ...
        if tipoaposta == "t" or tipoaposta == "p":
            ...
            resultado = verificar(sort1,sort2,sort3,tipoaposta,apostas)
        ...
        if moedas == 0:
            ...
            while iniciar != "1" and iniciar != "3":
                iniciar = input("Informe uma opção válida, [1] para continuar ou [3] para sair: ")
    ...
    arquivo.close()
    print("")
    print("seu saldo final foi:",moedas,"moedas e",pontos,"pontos")
